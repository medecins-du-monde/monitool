...
const svgAsDataUri = function(el, scaleFactor) {
...
const saveSvgAsPng = function(el, name, scaleFactor) {
	const uri = svgAsDataUri(el, scaleFactor)
...
module.component('exportSvg', {
	bindings: {},
	template: `
		<button ng-click="$ctrl.onClick()" class="btn btn-primary btn-xs pull-right noprint">
	...
	controller: function() {
		this.onClick = function() {
			...
			saveSvgAsPng(sourceSVG, 'file.png', 1);
		}
	}
});
