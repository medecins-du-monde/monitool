...
router.get('/:modelName(project|indicator|input|report|theme|type|user)', function(request, response) {
...
router.get('/:modelName(project|indicator|input|report|theme|type|user)/:id', function(request, response) {
	var Model = ModelsByName[request.params.modelName];
